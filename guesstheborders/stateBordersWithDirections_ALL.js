...
const AceMessage = [
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"💯 <span class='acemessage' id='acemessage'>You aced that board, Magellan!</span>",
	"🏆 <span class='acemessage' id='acemessage'>Not a single miss.  Geography legend!</span>", 
	"💯 <span class='acemessage' id='acemessage'>And that's a perfect game! Nice job!</span>", 
	"🗺️ <span class='acemessage' id='acemessage'>Aced it! Are you a cartographer by any chance?</span>",
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"🧹 <span class='acemessage' id='acemessage'>That's a clean sweep!</span>", 
	"💯 <span class='acemessage' id='acemessage'>You aced the board!</span>", 
	"💯 <span class='acemessage' id='acemessage'>You aced the board!</span>",
	"💯 <span class='acemessage' id='acemessage'>You aced the board!</span>",
	"💯 <span class='acemessage' id='acemessage'>And that's a perfect game! Nice job!</span>", 
	"💯 <span class='acemessage' id='acemessage'>And that's a perfect game! Nice job!</span>", 
