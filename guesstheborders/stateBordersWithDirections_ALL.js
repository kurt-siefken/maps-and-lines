...
const WinnerMessage = [
	...
	"Rand McNally called... and you’re hired!",
	"Nice game, geography whiz!",
	"That's a game winner!", 
	"That's a game winner!", 
	"That's a game winner!", 
	"That's a game winner!", 
	"That's a game winner!", 
	"That's a game winner!", 
	"Winner! Your 5th grade social studies teacher would be proud.", 
	"That's a winner! Congrats!", 
	"Well played. That's a winner!",
	"Ding ding! That's a game winner!",  
	"Winner winner, burrito dinner!",
	"Well played. That's a winner!",
	"Well played. That's a winner!",
	"Well played. That's a winner!",
	"Nice game. That's a winner!",
	"Nice game. That's a winner!",
	"And... that's a game winner!",
];

const AceMessage = [
	"🧹 That's a clean sweep!", 
	"💯 You aced that board, Magellan!",
	"🏆 Not a single miss.  Geography legend!", 
	"💯 And that's a perfect game! Nice job!", 
	"🗺️ Aced it! Are you a cartographer by any chance?",
	"🧹 That's a clean sweep!", 
	"🧹 That's a clean sweep!", 
	"🧹 That's a clean sweep!", 
	"🧹 That's a clean sweep!", 
