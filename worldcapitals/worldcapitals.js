...
newcapitallist.push("Sydney", "Belize City", "Cotonou", "Santa Cruz de la Sierra", "São Paulo", "Douala", "Toronto", "Shanghai", "Abidjan", "Guayaquil", "Bata", "Mumbai", "Almaty", "Schaan", "Birkirkara", "Weno", "Casablanca", "Yangon", "Auckland", "Lagos", "Karachi", "Koror", "Quezon City", "Serravalle", "Johannesburg", "Omdurman", "Colombo", "Zürich", "New Taipei", "Dar es Salaam", "Chaguanas", "Istanbul", "Dubai", "New York City", "Ho Chi Minh City", "Osaka", "Chongqing", "Kolkata", "Guangzhou", "Los Angeles", "Bangalore", "Barcelona", "Saint Petersburg",  "Chicago", "Vancouver", "Alexandria", "Salvador", "Milan", "Hamburg", "Munich", "Mandalay", "Port Elizabeth", "Rotterdam", "Perth", "La Plata", "Krakow", "Marrakesh", "Timbuktu");
...
function StartGame() {
	...
	var select = document.getElementById("ListOfCapitals");
	for(var i = 0; i < capitallist.length; i++) {
    	var opt = capitallist[i];
    	var el = document.createElement("option");
    	el.textContent = newcapitallist[i];
    	el.value = newcapitallist[i];
...
function NewRound() {
	...
	document.getElementById("ListOfCapitals").value = '';
...
function CheckAnswer() {
	var selectedanswer = ListOfCapitals.value;
	if (selectedanswer != '') {


	if (selectedanswer.split(" ").join("") == document.getElementById('capitalid').innerHTML.split(" ").join(""))
	{
...
function StartAutoComplete() {
	autocomplete(document.getElementById("ListOfCapitals"), newcapitallist);
}
